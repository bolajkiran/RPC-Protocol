        ...
        loop:while (true) {
            ...
            switch (s) {
                case 1:
                    ...
                    System.out.println("Pi_value received from server : " + service.calculate_pi());
                    break;
                case 2:
                    ...
                    System.out.println("Sum received from server: " + service.add(num1, num2));
                    break;
                case 3:
                    ...
                    System.out.println("Sorted numbers received from server are: ");
                    for(int i = 1; i <= n; i++) {
                ...
                case 4:
                        ...
                        if (colA == rowB) {
                            ...
                            System.out.println("Multiplication result received from server is:");
                            for (int i = 0; i < rowA; i++) {
                                for (int j = 0; j < colB; j++) {
